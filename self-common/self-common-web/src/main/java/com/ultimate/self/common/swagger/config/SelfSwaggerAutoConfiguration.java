package com.ultimate.self.common.swagger.config;
...
public class SelfSwaggerAutoConfiguration {
    ...
    private static Parameter buildTenantHeaderParameter() {
        return new Parameter()
                .name(CommonConstants.TENANT_ID) // header 名
                .description("租户编号") // 描述
                .in(String.valueOf(SecurityScheme.In.HEADER)) // 请求 header
                .schema(new IntegerSchema()._default(1L).name(CommonConstants.TENANT_ID).description("租户编号")); // 默认：使用租户编号为 1
    }
    ...
    private static Parameter buildSecurityHeaderParameter() {
        return new Parameter()
                ...
                .in(String.valueOf(SecurityScheme.In.HEADER)) // 请求 header
                .schema(new StringSchema()._default("Bearer test1").name(CommonConstants.TENANT_ID).description("认证 Token")); // 默认：使用用户编号为 1
    }
