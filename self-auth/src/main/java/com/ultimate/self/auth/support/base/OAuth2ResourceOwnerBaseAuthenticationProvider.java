package com.ultimate.self.auth.support.base;
...
import com.ultimate.self.common.security.util.OAuth2ErrorCodesExpand;
import com.ultimate.self.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		try {
			...
			if (Objects.isNull(onlineQuantity) || BooleanUtil.toBoolean((String) onlineQuantity)) {
			...
			SfaRedisOAuth2AuthorizationService redisOAuth2AuthorizationService = (SfaRedisOAuth2AuthorizationService) this.authorizationService;
	...
	private OAuth2AuthenticationException oAuth2AuthenticationException(Authentication authentication,
		...
		if (authenticationException instanceof LoginErrorException) {
			return new OAuth2AuthenticationException(new OAuth2Error(OAuth2ErrorCodesExpand.LOGIN_ERROR,
