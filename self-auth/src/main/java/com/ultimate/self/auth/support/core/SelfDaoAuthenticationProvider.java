...
import com.ultimate.org.api.constans.SmsSendConstants;
import com.ultimate.self.auth.support.password.SelfPasswordEncoder;
import com.ultimate.self.auth.utils.AESUtils;
...
public class SelfDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		if (StrUtil.isNotBlank(mode) && mode.equals("sms")) {
			...
			Object code = bean.opsForValue().get(String.format(SmsSendConstants.loginCacheKey, phone));
